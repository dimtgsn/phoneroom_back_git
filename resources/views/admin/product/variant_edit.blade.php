                ...
                <div class="card-wrapper col-8">
                    <div class="">
                        <div class="card card-danger">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.products.variant_update', [$product->slug, $variant['slug']]) }}" method="post" class="pt-3 my-login-validation" enctype="multipart/form-data">
                                    @csrf
                                    @method('patch')
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input value="{{ $variant['product_name'] }}" placeholder="{{ $variant['product_name'] }}" name="name" type="text"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <span>*Мой склад</span>
                                        <input value="{{ $variant['country'] }}" placeholder="{{ $variant['country'] }}" name="country" type="text"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <label for="image" class="custom-file-label">{{ $variant['image'] }}</label>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                                  id="description" autocomplete="description" autofocus>{{ $variant['description'] }}</textarea>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input value="{{ $variant['price'] }}" placeholder="{{ $variant['price'] }}" name="price" type="number"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <span>*Мой склад</span>
                                        <input value="{{ $variant['min_price'] }}" placeholder="{{ $variant['min_price'] }}" name="min_price" type="text"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <span>*Мой склад</span>
                                        <input value="{{ $variant['purchase_price'] }}" placeholder="{{ $variant['purchase_price'] }}" name="purchase_price" type="text"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input value="{{ $variant['old_price'] }}" placeholder="{{ $variant['old_price'] }}" name="old_price" type="number"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input value="{{ $variant['units_in_stock'] }}" placeholder="{{ $variant['units_in_stock'] }}" name="units_in_stock" type="number"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <span>*Мой склад</span>
                                        <input value="{{ $variant['min_balance'] }}" placeholder="{{ $variant['min_balance'] }}" name="min_balance" type="text"
                                    ...
                                    <div class="form-group mb-4" id="wo">
                                        <div class="option">
                                            ...
                                            @if(!empty($variant))
                                                @foreach($variant['options'] as $key => $value)
                                                    <div class="options mt-3">
                                                        <input placeholder="Название" disabled value="{{ $key }}" name="options[0][name]" type="text"
                                                        ...
                                                        <div class="option_values">
                                                            <input placeholder="Значение" disabled value="{{ $value }}" name="options[0][values][]" type="text"
                                            ...
                                            @else
                                                <div class="options mt-3">
                                                    <input placeholder="Название" value="{{ $key }}" name="options[0][name]" type="text"
                                                           class="form-control w-75 d-inline-block @error('options') is-invalid @enderror"
                                                           id="options1" required
                                                           autocomplete="options" autofocus list="options">
