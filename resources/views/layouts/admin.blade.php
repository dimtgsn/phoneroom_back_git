...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{ asset(\App\Models\Logo::all()->first()->path) }}" alt="AdminLTELogo" height="60"
             width="60">
    </div>
    <!-- Navbar -->
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.index') }}"
                   class="{{ Request::is('admin') ? 'active' : '' }} nav-link">Главная</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.profiles.index', auth()->user()->profile->slug) }}"
                   class="{{ Request::is('admin/profiles*') ? 'active' : '' }} nav-link">Профиль</a>
            </li>
            @if(Auth::user()->position->name === 'admin')
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('admin.users.index')}}"
                       class="{{ Request::is('admin/users*') ? 'active' : '' }} nav-link">Пользователи</a>
                </li>
            @endif
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('admin.my-warehouse.index') }}"
                   class="{{ Request::is('admin/my-warehouse*') ? 'active' : '' }} nav-link">Мой склад</a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <div class="brand-link d-flex align-items-center justify-content-start">
            ...
            <a href="{{ route('admin.logo.edit') }}" class="text-white pl-4">
                <i class="fa fa-regular fa-pen pl-1"></i>
            </a>
        </div>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    ...
                    <img src="{{ asset('dist/img/77086a4ce9dcc164c77db76c7853f012.jpg') }}"
                         class="img-circle elevation-2"
                         alt="User Image">
                </div>
                <div class="info">
                    <a href="{{ route('admin.profiles.index', Auth::user()->profile->slug) }}" class="d-block">{{ Auth::user()->first_name }}</a>
                </div>
    ...
    <footer class="main-footer">
        <strong class="text-md">Copyright &copy; {{Date::now()->year}} {{ env('app_name') }}</strong>
    </footer>
    <!-- /.control-sidebar -->
</div>
<!-- ./wrapper -->
